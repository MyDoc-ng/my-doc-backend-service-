...
export class AdminController {
  ...
  static async updateDoctorStatus(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
      ...
      const result = await AdminService.updateDoctorStatus(doctorId, isApproved);
      res.status(result.status || 200).json(result);
    } catch (error: any) {
  ...
  static async resolveDispute(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
      ...
      const result = await AdminService.resolveDispute(disputeId, resolution, refund);
      res.status(result.status || 200).json(result);
    } catch (error: any) {
  ...
  static async updateWithdrawalStatus(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
      const { withdrawalId } = req.params;
      const { status } = req.body;
      
      logger.info('Updating withdrawal status', { withdrawalId, status });
      const result = await AdminService.updateWithdrawalStatus(withdrawalId, status);
      res.status(result.status || 200).json(result);
    } catch (error: any) {
  ...
  static async updateCommissionRate(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
      const { rate } = req.body;
  ...
  // API Monitoring
  static async getApiLogs(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
      const filters = req.query;
